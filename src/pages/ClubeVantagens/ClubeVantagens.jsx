        ...
        <section className="service-hero">
          <div className="container">
            <div className="service-hero__content">
              <h1 className="service-hero__title">Clube de Vantagens</h1>
              <p className="service-hero__slogan">
                Fidelização e benefícios exclusivos para seus clientes
              </p>
              <p className="service-hero__subtitle">
                Crie um programa de benefícios completo que aumenta o ticket médio e a frequência de compras.
              </p>
