        ...
        <section className="service-hero">
          <div className="container">
            <div className="service-hero__content">
              <h1 className="service-hero__title">Gamificação</h1>
              <p className="service-hero__slogan">
                Transforme a experiência do cliente em um jogo envolvente
              </p>
              <p className="service-hero__subtitle">
                Estratégias de gamificação para aumentar o engajamento, interação e fidelização através de mecânicas divertidas.
              </p>
